...
export function SubscriptionLinks() {
  return (
    <div className="flex flex-col items-center justify-center">
      <p className={"text-center text-3xl lg:text-5xl"}>Colaborá <strong><em>mensualmente</em></strong></p>
      <div
        className={
...
function PaymentLink({ name, link }: PaymentLink) {
  return (
    <a
      href={link}
      className="inline-flex w-full items-center justify-center rounded-lg bg-black p-4 text-xl text-orange-100 shadow-sm ring-1 ring-inset ring-orange-950 first:mt-0 last:mb-0 hover:bg-orange-600"
    >
      <CurrencyDollarIcon
