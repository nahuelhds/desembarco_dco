...
function PaymentLink({ name, link }: PaymentLink) {
  return (
    <a
      href={link}
      className="inline-flex w-full items-center justify-center rounded-lg bg-red-900 p-3 text-xl text-orange-100 shadow-sm ring-1 ring-inset ring-orange-950 first:mt-0 last:mb-0 hover:bg-orange-600"
    >
      <CurrencyDollarIcon
